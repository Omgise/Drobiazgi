...
public final class CustomNpcsSpawningConfig {
    ...
    @Comment({ "Spawn rules. One rule per line. Keys are key=value separated by ';'.",
        ...
        "biomeMode, time, light, y, water, requireWater, cave.",
        "water=true allows spawning on liquid surfaces. requireWater=true requires a submerged spawn in a surface",
        "water column. cave=true spawns underground instead of at surface.",
